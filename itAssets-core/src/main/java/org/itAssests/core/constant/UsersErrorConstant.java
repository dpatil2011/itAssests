...
public class UsersErrorConstant extends ErrorConstant{
	...
	public static final com.anabatic.generic.core.exception.Error EMPLOYEE_ID = new Error("user-101","EMPLOYEE_ID already assign to other user", "EMPLOYEE_ID already assign to other user");
